...
<template>
    <Breadcrumbs :breadcrumbs="[{ name: 'Каталог', url: '/catalog' }]" :page="`${$route.params.id}`" />
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="md:w-2/3">
                                ...
                                <div class="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <button
                                        class="flex-1 bg-white border border-blue-600 text-blue-600 py-3 px-4 rounded-md text-sm font-medium hover:bg-blue-50 transition-colors flex items-center justify-center">
    ...
    const mockProducts = [
        {
            ...
            description:
                "LED-драйвер Gigant предназначен для питания светодиодных светильников мощностью 36Вт с выходным напряжением 54В. Обеспечивает стабильное питание и защиту светодиодных модулей от перепадов напряжения. Подходит для промышленного и коммерческого освещения.",
            price: "3 842",
            oldPrice: "4 200",
            rating: 4.5,
            reviews: 12,
