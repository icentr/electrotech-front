                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
                        ...
                        <div v-if="cartItems.length > 0">
                            <div v-for="item in cartItems" :key="item.id" class="flex flex-col md:grid grid-cols-3 md:grid-cols-12 gap-4 py-4 border-b border-gray-100">
                                ...
                                <div class="col-span-3 md:col-span-6 flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <button class="md:text-sm text-red-600 hover:text-red-800 mt-2 flex items-center" @click="removeFromCart(item.id)">
