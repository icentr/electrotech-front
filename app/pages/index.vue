...
<template>
    <div class="bg-gray-50">
            ...
            <div class="container mx-auto px-4 py-20 md:py-28">
                <div class="flex flex-col items-center md:flex-row">
                    <div class="mb-12 md:mb-0 md:w-1/2">
                        <div class="bg-opacity-20 mb-6 inline-block rounded-full bg-white px-5 py-1.5">
                            <span class="text-accent text-sm font-medium tracking-wide">БЕСПЛАТНАЯ ДОСТАВКА ДО ТК</span>
                        </div>
                        <h1 class="mb-6 text-4xl leading-tight font-bold md:text-5xl">
                            КОМПЛЕКТУЮЩИЕ ДЛЯ ПРОМЫШЛЕННОЙ ЭЛЕКТРОТЕХНИКИ
                        </h1>
                        <p class="mb-8 max-w-lg text-xl opacity-90">
                            Автоматические выключатели, блоки питания, клеммы, контроллеры и
                        ...
                        <div class="mt-10 flex flex-wrap gap-3">
                            ...
                            <div
                                class="bg-opacity-20 flex items-center gap-2 rounded-full bg-white px-4 py-2 backdrop-blur-sm">
                                <CheckCircleIcon class="text-accent size-6" />
                                <span class="text-accent text-sm">Техническая консультация</span>
                            </div>
                        </div>
                    </div>

                    <div class="relative md:w-1/2">
                        <div class="bg-opacity-20 rounded-2xl bg-white p-3 shadow-2xl backdrop-blur-sm">
                            <div
                                class="flex h-80 w-full items-center justify-center rounded-xl border-2 border-gray-200 bg-gray-100">
                        ...
                        <div
                            ...
                            <a :href="'tel:' + PHONE_NUMBER_NORMALIZED" class="hover:text-accent text-lg font-bold">{{
                                PHONE_NUMBER }}</a>
            ...
            <div class="container mx-auto px-4">
                <div class="mb-12 flex flex-col items-center justify-between md:flex-row">
                    ...
                    <a href="catalog"
                        ...
                        <span class="group-hover:border-accent/80 border-b border-transparent transition-colors">Весь
                            каталог</span>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <a v-for="category in PREVIEW_CATEGORIES" href="catalog"
                        ...
                        <h3 class="group-hover:text-accent mb-2 text-lg font-bold text-gray-900 transition-colors">
                            {{ category.title }}
                        </h3>
                        <p class="text-sm text-gray-600">
                            {{ category.description }}
                        </p>
                        <div class="text-accent mt-4 flex items-center text-sm font-medium transition-colors">
                            Смотреть товары
        ...
        <!-- Баннер с призывом -->
        <section class="bg-gradient-to-r from-[#006699] to-[#0081b6] py-16 text-white">
        ...
        <section id="contact-form" class="bg-white py-16">
            <div class="container mx-auto px-4">
                <div class="mx-auto max-w-4xl overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md">
                    <div class="md:flex">
                        ...
                        <div class="p-4 md:w-1/2 md:p-10">
                            <form>
                                <div class="mb-5">
                                    <label for="company" class="mb-2 block font-medium text-gray-700">Название
                                        компании*</label>
                                    <input type="text" id="company"
                                        class="focus:ring-opacity-50 w-full rounded-lg border border-gray-300 px-4 py-3 transition focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
                                        required />
                                </div>
                                <div class="mb-5">
                                    <label for="name" class="mb-2 block font-medium text-gray-700">Контактное
                                        лицо*</label>
                                ...
                                <div class="mb-5">
                                    <label for="phone" class="mb-2 block font-medium text-gray-700">Телефон*</label>
                                    <input type="tel" id="phone"
                                        class="focus:ring-opacity-50 w-full rounded-lg border border-gray-300 px-4 py-3 transition focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
                                        required />
                                </div>
                                <div class="mb-6">
                                    <label for="message" class="mb-2 block font-medium text-gray-700">Интересующие
                                        товары</label>
