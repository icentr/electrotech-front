...
<template>
  <div class="bg-gray-50 antialiased">
      ...
      <div class="container mx-auto px-4 py-20 md:py-28">
        <div class="flex flex-col md:flex-row items-center">
          <div class="md:w-1/2 mb-12 md:mb-0">
            <div
              class="bg-white bg-opacity-20 rounded-full px-5 py-1.5 inline-block mb-6"
            >
              <span class="font-medium text-sm tracking-wide text-blue-600"
                >БЕСПЛАТНАЯ ДОСТАВКА ДО ТК ОТ 50 000 ₽</span
              >
            </div>
            <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              КОМПЛЕКТУЮЩИЕ ДЛЯ ПРОМЫШЛЕННОЙ ЭЛЕКТРОТЕХНИКИ
            </h1>
            <p class="text-xl mb-8 opacity-90 max-w-lg">
              Контроллеры, автоматические выключатели, блоки питания, клеммы и
              другие электротехнические компоненты для предприятий
            </p>
            ...
            <div class="mt-10 flex flex-wrap gap-3">
              <div
                class="flex items-center bg-white bg-opacity-20 rounded-full px-4 py-2 backdrop-blur-sm"
              >
          ...
          <div class="md:w-1/2 relative">
            <div
              class="bg-white bg-opacity-20 rounded-2xl p-3 shadow-2xl backdrop-blur-sm"
            >
              <div
            ...
            <div
              class="absolute -bottom-6 -right-6 bg-white text-gray-900 p-6 rounded-xl shadow-hard w-48 floating-phone border border-gray-100"
            >
    ...
    <section class="py-16 bg-white">
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div
              class="bg-blue-600 bg-opacity-10 rounded-full w-14 h-14 flex items-center justify-center mb-6"
            >
              <i class="fas fa-truck text-blue-600 text-2xl"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-gray-900">Доставка до ТК</h3>
            <p class="text-gray-600">
              Бесплатная доставка до транспортной компании при заказе от 50 000
              рублей
            </p>
          </div>
          ...
          >
            ...
            <p class="text-gray-600">
              Контроллеры, автоматы, блоки питания, клеммы и другие
      ...
      <div class="container mx-auto px-4">
        ...
        >
          <div>
            ...
            <p class="text-gray-600">
              Широкий ассортимент электротехнических компонентов
            </p>
          </div>
          <a
            href="#"
            class="mt-4 md:mt-0 flex items-center text-blue-600 font-medium hover:text-blue-800 group"
          >
            <span
              class="border-b border-transparent group-hover:border-blue-600 transition-colors"
              >Весь каталог</span
            >
            <i
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <h3
              class="text-lg font-bold mb-2 text-gray-900 group-hover:text-blue-600 transition-colors"
            >
            ...
            <div
              class="mt-4 text-blue-600 font-medium flex items-center text-sm group-hover:text-blue-800 transition-colors"
            >
              Смотреть товары
              <i
                class="fas fa-chevron-right ml-2 text-xs transition-transform group-hover:translate-x-1"
              ></i>
            </div>
          </a>
    ...
    <!-- Баннер с призывом -->
    <section
      class="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white"
    >
      <div class="container mx-auto px-4 text-center">
        <div class="max-w-4xl mx-auto">
          <h2 class="text-3xl font-bold mb-6">
            НУЖНА КОНСУЛЬТАЦИЯ ПО ПОДБОРУ КОМПЛЕКТУЮЩИХ?
          </h2>
          <p class="text-xl mb-8 opacity-90">
            Наши специалисты помогут подобрать оптимальные решения для вашего
            предприятия
          </p>
    ...
    <section id="contact-form" class="py-16 bg-white">
      <div class="container mx-auto px-4">
        <div
          class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden border border-gray-100"
        >
          <div class="md:flex">
            <div
              class="md:w-1/2 bg-gradient-to-b from-blue-700 to-blue-600 text-white p-10"
            >
              ...
              <div class="space-y-5">
                <div class="flex items-start">
                  ...
                  <div>
                    <h3 class="font-bold text-sm text-blue-200">
                ...
                <div class="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:sales@electro-tech.ru"
                      class="text-lg font-medium hover:underline"
                      >sales@electro-tech.ru</a
                    >
                  </div>
                </div>
                <div class="flex items-start">
