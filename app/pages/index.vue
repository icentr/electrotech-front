...
<template>
    <div class="bg-gray-50">
                ...
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 mb-12 md:mb-0">
                        ...
                        <h1 class="text-4xl md:text-5xl font-bold mb-6 leading-tight">КОМПЛЕКТУЮЩИЕ ДЛЯ ПРОМЫШЛЕННОЙ
                            ЭЛЕКТРОТЕХНИКИ</h1>
                        <p class="text-xl mb-8 opacity-90 max-w-lg">Автоматические выключатели, блоки питания, клеммы,
                            контроллеры и другие электротехнические компоненты для предприятий</p>

                        <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                            <a href="#contact-form"
                                class="bg-white text-[#0081b6] font-bold py-4 px-8 rounded-lg hover:bg-gray-100 transition duration-300 flex items-center justify-center shadow-md hover:shadow-lg">
                                <PhoneIcon class="size-6 me-3" />
                                ЗАКАЗАТЬ ЗВОНОК
                            </a>
                            <RouterLink to="catalog"
                                class="bg-transparent border-2 border-white text-white font-bold py-4 px-8 rounded-lg hover:bg-white hover:text-[#0081b6] transition duration-300 flex items-center justify-center hover:shadow-lg">
                        ...
                        <div class="mt-10 flex flex-wrap gap-3">
                            <div
                                class="flex items-center bg-white bg-opacity-20 rounded-full px-4 py-2 backdrop-blur-sm gap-2">
                            ...
                            <div
                                class="flex items-center bg-white bg-opacity-20 rounded-full px-4 py-2 backdrop-blur-sm gap-2">
                                <CheckCircleIcon class="size-6 text-[#0081b6]" />
                                <span class="text-sm text-[#0081b6]">Оригинальные компоненты</span>
                            </div>
                            <div
                                class="flex items-center bg-white bg-opacity-20 rounded-full px-4 py-2 backdrop-blur-sm gap-2">
                                <CheckCircleIcon class="size-6 text-[#0081b6]" />
                                <span class="text-sm text-[#0081b6]">Техническая консультация</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:w-1/2 relative">
                        <div class="bg-white bg-opacity-20 rounded-2xl p-3 shadow-2xl backdrop-blur-sm">
                            <div
                                class="bg-gray-100 border-2 border-gray-200 rounded-xl w-full h-80 flex items-center justify-center">
                                <img src="assets/Logo_Index.PNG" alt="Электротехника"
                                    class="rounded-lg object-cover h-full w-full" />
                            </div>
                        </div>
                        <div
                            class="absolute m-x-4 md:-bottom-6 md:-right-6 bg-white text-gray-900 p-4 md:p-6 rounded-xl shadow-hard w-max md:min-w-48 floating-phone border border-gray-100">
                            <div class="flex items-center mb-2">
                                <div class="bg-[#0081b6] rounded-full p-2 mr-3 pulse-animation">
                            ...
                            <a :href="'tel:' + PHONE_NUMBER_NORMALIZED"
                                class="text-lg font-bold hover:text-[#0081b6]">{{
                                    PHONE_NUMBER }}</a>
                            <div class="text-xs text-gray-500 mt-1">Пн-Пт: 9:00-18:00</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Преимущества с вашими условиями -->
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <h2 class="text-3xl font-bold text-center text-gray-900 mb-4">НАШИ ПРЕИМУЩЕСТВА</h2>
                <p class="text-center text-gray-600 max-w-2xl mx-auto mb-12">Работаем с юридическими лицами по
                    безналичному расчету</p>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div
                        class="feature-card bg-gray-50 rounded-xl p-8 transition-all duration-300 border border-gray-100 hover:border-blue-200">
                        <div
                            class="bg-[#0081b6] bg-opacity-10 rounded-full w-14 h-14 flex items-center justify-center mb-6">
                            <TruckIcon class="size-9 text-white" />
                        </div>
                        <h3 class="text-xl font-bold mb-3 text-gray-900">Доставка до ТК</h3>
                        <p class="text-gray-600">Бесплатная доставка до транспортной компании. Бесплатная доставка по
                            Москве в пределах МКАД при заказе от 50 000 ₽</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Автоматы, блоки питания, клеммы, контроллеры и другие
                            электротехнические компоненты</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-600">Работаем по безналичному расчету с НДС. Индивидуальные условия для
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row justify-between items-center mb-12">
                    ...
                    <a href="catalog"
                        class="mt-4 md:mt-0 flex items-center text-[#0081b6] font-medium hover:text-blue-800 group">
                        <span class="border-b border-transparent group-hover:border-blue-600 transition-colors">Весь
                            каталог</span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="catalog"
                        ...
                        <div
                            class="bg-blue-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-blue-600 group-hover:text-white text-blue-600 transition-colors">
                            В</div>
                        <h3 class="text-lg font-bold mb-2 text-gray-900 group-hover:text-[#0081b6] transition-colors">
                            Автоматические выключатели</h3>
                        <p class="text-gray-600 text-sm">Защита электроцепей от перегрузок и КЗ</p>
                        <div
                            class="mt-4 text-[#0081b6] font-medium flex items-center text-sm group-hover:text-blue-800 transition-colors">
                            Смотреть товары
                    ...
                    <a href="catalog"
                        class="group bg-white rounded-xl shadow-sm p-6 transition-all duration-300 hover:shadow-md hover:border-blue-600 hover:border hover:-translate-y-1 border border-transparent">
                        <div
                            class="bg-blue-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4 group-hover:bg-blue-600 group-hover:text-white text-[#0081b6] transition-colors">
                            БП</div>
                        <h3 class="text-lg font-bold mb-2 text-gray-900 group-hover:text-[#0081b6] transition-colors">
                            Блоки питания</h3>
        ...
        <!-- Баннер с призывом -->
        <section class="py-16 bg-gradient-to-r from-[#006699] to-[#0081b6] text-white">
            <div class="container mx-auto px-4 text-center">
                <div class="max-w-4xl mx-auto">
                    <h2 class="text-3xl font-bold mb-6">НУЖНА КОНСУЛЬТАЦИЯ ПО ПОДБОРУ КОМПЛЕКТУЮЩИХ?</h2>
                    <p class="text-xl mb-8 opacity-90">Наши специалисты помогут подобрать оптимальные решения для вашего
                        предприятия</p>
                ...
                <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    <div class="md:flex">
                        ...
                        <div class="md:w-1/2 p-4 md:p-10">
                            <form>
                                <div class="mb-5">
                                    <label for="company" class="block text-gray-700 mb-2 font-medium">Название
                                        компании*</label>
                                ...
                                <div class="mb-5">
                                    <label for="name" class="block text-gray-700 mb-2 font-medium">Контактное
                                        лицо*</label>
                                ...
                                <div class="mb-6">
                                    <label for="message" class="block text-gray-700 mb-2 font-medium">Интересующие
                                        товары</label>
