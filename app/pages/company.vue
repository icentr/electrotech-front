                    ...
                    <div class="flex flex-col items-center">
                        <div>
                            ...
                            <p class="text-gray-600 mb-6 text-lg leading-relaxed text-balance">
                                ...
                                уже более 10 лет является надежным поставщиком электротехнических компонентов для
                                промышленных предприятий. Мы специализируемся проектирование и сборка НКУ любой
                                сложности и конфигурации.
                                <a class="transition-all duration-200 text-accent hover:text-blue-800 hover:underline active:underline"
                                    href="https://icentr.pro/" target="_blank">
                                    Наш сайт
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                <a href="https://icentr.pro" target="_blank"
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                    <div class="md:flex">
                        <div class="md:w-1/2 bg-accent text-white p-10">
