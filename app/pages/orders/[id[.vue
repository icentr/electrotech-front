<template>
  ...
  class="text-lg font-bold text-gray-900 hover:text-blue-600 transition-colors line-clamp-2 block mb-1"
>
  {{ product.productName }}
</NuxtLink>
          ...
          <div class="mt-auto">
            <div class="flex justify-between items-center mb-4">
              ...
              <div
                ...
                class="text-gray-500 text-sm font-medium flex items-center"
              >
                <i class="fas fa-check-circle mr-1"></i> Количество ({{
                  product.quantity
                }})
              </div>
            </div>
      ...
      <div class="text-right text-xl font-bold mt-8">
