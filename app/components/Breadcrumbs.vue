        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li v-for="page in props.breadcrumbs" class="inline-flex items-center">
                    <NuxtLink :to="page.url" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
                        <ChevronRightIcon class="size-5" />
                        {{ page.name }}
                    </NuxtLink>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <ChevronRightIcon class="size-5" />
                        <span class="text-sm font-medium text-gray-500">{{ props.page }}</span>
                    </div>
                </li>
            </ol>
        </nav>
