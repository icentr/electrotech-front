...
<div class="bg-gray-50 antialiased">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-12 md:mb-0">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="#contact-form" class="bg-white text-blue-600 font-bold py-4 px-8 rounded-lg hover:bg-gray-100 transition duration-300 flex items-center justify-center shadow-md hover:shadow-lg">
                ...
                <div class="md:w-1/2 relative">
                    <div class="bg-white bg-opacity-20 rounded-2xl p-3 shadow-2xl backdrop-blur-sm">
                        <div class="bg-gray-100 border-2 border-gray-200 rounded-xl w-full h-80 flex items-center justify-center">
                            <img src="https://via.placeholder.com/500x300/1e3a8a/ffffff?text=Промышленные+контроллеры+и+автоматы" alt="Электротехника" class="rounded-lg object-cover h-full w-full">
                        </div>
                    </div>
                    <div class="absolute -bottom-6 -right-6 bg-white text-gray-900 p-6 rounded-xl shadow-hard w-48 floating-phone border border-gray-100">
                        ...
                        <a href="tel:+74951234567" class="text-lg font-bold hover:text-blue-600">+7 (495) 123-45-67</a>
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-center text-gray-600 max-w-2xl mx-auto mb-12">Работаем с юридическими лицами по безналичному расчету</p>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="#" class="group bg-white rounded-xl shadow-sm p-6 transition-all duration-300 hover:shadow-md hover:border-blue-600 hover:border hover:-translate-y-1 border border-transparent">
    ...
    <section class="py-16 bg-gradient-to-r from-blue-800 to-blue-600 text-white">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-4xl mx-auto">
                ...
                <p class="text-xl mb-8 opacity-90">Наши специалисты помогут подобрать оптимальные решения для вашего предприятия</p>
                
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                    <a href="tel:+74951234567" class="bg-white text-blue-600 font-bold py-4 px-8 rounded-lg hover:bg-gray-100 transition duration-300 flex items-center justify-center shadow-md hover:shadow-lg">
                        <i class="fas fa-phone-alt mr-3"></i>
                        Позвонить сейчас
                    </a>
                    ...
                    <div class="md:w-1/2 p-10">
                        <form>
                            <div class="mb-5">
                                ...
                                <input type="text" id="company" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 focus:ring-opacity-50 transition" required>
                            </div>
                            <div class="mb-5">
                                <label for="name" class="block text-gray-700 mb-2 font-medium">Контактное лицо*</label>
                            ...
                            <div class="mb-6">
                                <label for="message" class="block text-gray-700 mb-2 font-medium">Интересующие товары</label>
                                <textarea id="message" rows="3" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 focus:ring-opacity-50 transition" placeholder="Например: контроллеры ABB, клеммы WAGO..."></textarea>
                            </div>
