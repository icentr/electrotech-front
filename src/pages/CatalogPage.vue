          ...
          <div class="bg-white rounded-lg shadow-sm p-5 sticky top-4">
              ...
              <ul class="space-y-2">
                <li v-for="category in categories" :key="category.id">
                  <label class="text-gray-600 hover:text-blue-600 text-sm flex items-center cursor-pointer">
                    <input type="checkbox" class="mr-2" :value="category.name"
            ...
            <div class="mb-6">
              ...
              <div class="flex items-center space-x-3 mb-3">
                <input v-model.number="priceMin" type="number" placeholder="От"
                  class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
                <span class="text-gray-400">—</span>
                <input v-model.number="priceMax" type="number" placeholder="До"
                  class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
              </div>
            </div>
            ...
            <div class="mb-6" v-for="filter in filters" :key="filter.id">
              ...
              <ul class="space-y-2">
                <li v-for="option in filter.options" :key="option.id">
                  <label class="text-gray-600 hover:text-blue-600 text-sm flex items-center cursor-pointer">
                    <input type="checkbox" class="mr-2" :value="option.name"
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div class="flex items-center">
                ...
                <select v-model="sortOption"
                  class="border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded-md text-sm">
